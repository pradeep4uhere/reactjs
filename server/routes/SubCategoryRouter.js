/*
 * @PageName    :: SubCategoryRouter.js
 * @Author      :: Pradeep Kumar
 * @Description :: All routing of sub category module
...
SubCategoryRouter.route('/gettag').post(function (req, res) {
...
SubCategoryRouter.route('/deltag').post(function (req, res) {
  var id = req.body.id;
  var token = req.body.token;
...
SubCategoryRouter.route('/addtag').post(function (req, res) {
